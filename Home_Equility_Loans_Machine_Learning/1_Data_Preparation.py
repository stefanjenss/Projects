"""
Home Equity Loans Machine Learning - Part 1: Data Preparation

In this phase, the Home Equity Loan data is expored and prepared for predictive modeling.

Data Praparation Script Overview:
1. Set up the environment.
2. Read the HMEQ dataset into Python
...
# Import the data
INFILE = "/Users/stefanjenss/Documents/DataScience/Projects/Home_Equility_Loans_Machine_Learning/HMEQ_Loss.csv"
...
# Add TARGET_LOSS_AMT to the floatList
floatList.append(TARGET_A)
